...
describe("api", () => {
  ...
  describe("update technical owner", () => {
    it("sends changed owner to the API", async () => {
      server.use(
        rest.post(
          "/api/systems/678/update-technical-owner",
          (req, res, ctx) => {
    ...
    it("removes the technical owner when no value is provided", async () => {
      server.use(
        rest.post(
          "/api/systems/987/update-technical-owner",
          (req, res, ctx) => {
            const { technical_owner: technicalOwner } = req.body;
    ...
    it("raises error if validation fails", async () => {
      server.use(
        rest.post(
          "/api/systems/765/update-technical-owner",
          (req, res, ctx) => {
            return res(
              ctx.status(400),
              ctx.json({
    ...
    it("raises error if system does not exist", async () => {
      server.use(
        rest.post(
          "/api/systems/999/update-technical-owner",
          (req, res, ctx) => {
      ...
      await expect(pendingSystem).rejects.toBeInstanceOf(
  ...
  describe("update information asset owner", () => {
    it("sends changed owner to the API", async () => {
      server.use(
        rest.post(
          "/api/systems/678/update-information-asset-owner",
          (req, res, ctx) => {
    ...
    it("removes the information asset owner when no value is provided", async () => {
      server.use(
        rest.post(
          "/api/systems/987/update-information-asset-owner",
          (req, res, ctx) => {
            const { information_asset_owner: informationAssetOwner } = req.body;
    ...
    it("raises error if validation fails", async () => {
      server.use(
        rest.post(
          "/api/systems/765/update-information-asset-owner",
          (req, res, ctx) => {
            return res(
              ctx.status(400),
              ctx.json({
    ...
    it("raises error if system does not exist", async () => {
      server.use(
        rest.post(
          "/api/systems/999/update-information-asset-owner",
          (req, res, ctx) => {
            return res(ctx.status(404));
          }
        )
  ...
  describe("update investment state", () => {
    it("sends changed investment state to the API", async () => {
      server.use(
        rest.post(
          "/api/systems/345/update-investment-state",
          (req, res, ctx) => {
  ...
  describe("add system", () => {
    it("sends new system information to the API", async () => {
      server.use(
  ...
  describe("update system description", () => {
    it("sends changed description to the API", async () => {
      server.use(
        rest.post(
          "/api/systems/456/update-system-description",
          (req, res, ctx) => {
    ...
    it("removes the description when an empty value is provided", async () => {
      server.use(
        rest.post(
          "/api/systems/234/update-system-description",
          (req, res, ctx) => {
            const { description } = req.body;
            if (description !== null) {
    ...
    it("raises error if validation fails", async () => {
      server.use(
        rest.post(
          "/api/systems/345/update-system-description",
          (req, res, ctx) => {
            return res(
              ctx.status(400),
              ctx.json({
