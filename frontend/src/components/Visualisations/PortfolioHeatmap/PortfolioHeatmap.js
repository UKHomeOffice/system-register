...
const PortfolioHeatmap = (props) => {
    ...
    const [selectedCell, setSelectedCell] = useState(
        { rootType: HO_ROOT, rootValue: 'Home Office', riskLens: 'combined', systems: props.systems }
    )
        ...
        setSelectedCell(
            {
                ...
                systems: props.systems.filter(s => s[PORTFOLIO_ROOT] === event.rootValue)
            }
        )
    }
        ...
        <div className="portfolioHeatmapContainer">
            ...
            <div className="visContainer">
              <div className="leftVis">
                <SystemsHeatmapVis systems={props.systems} view={selectedView} root={PORTFOLIO_ROOT} panelHeight="40" cellSelectedCallback={cellSelected} />
