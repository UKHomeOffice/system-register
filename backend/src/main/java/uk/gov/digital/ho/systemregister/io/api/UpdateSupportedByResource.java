...
import uk.gov.digital.ho.systemregister.application.messaging.commandhandlers.UpdateSupportedByCommandHandler;
import uk.gov.digital.ho.systemregister.application.messaging.commands.UpdateSupportedByCommand;
import uk.gov.digital.ho.systemregister.domain.SR_Person;
import uk.gov.digital.ho.systemregister.io.api.dto.UpdateSupportedByCommandDTO;
...
@Path("/api/systems")
public class UpdateSupportedByResource {
    private final UpdateSupportedByCommandHandler handler;
    private final AuthorMapper authorMapper;

    public UpdateSupportedByResource(UpdateSupportedByCommandHandler handler, AuthorMapper authorMapper) {
    ...
    @Authenticated
    @Path("/{systemId}/update-supported-by")
    public UpdatedSystemDTO updateTechnicalOwner(UpdateSupportedByCommandDTO dto,
        ...
        UpdateSupportedByCommand command = dto.toCommand(id, author, Instant.now());
