...
public class PortfolioUpdatedEventDAO_v1 extends BaseDao {
    public final int id;
    ...
    public PortfolioUpdatedEventDAO_v1(int id, Instant timestamp, Person author) {
        this(id, null, timestamp, author);
    }

    public PortfolioUpdatedEventDAO_v1(int id, String portfolio, Instant timestamp, Person author) {
        super(timestamp);
        this.id = id;
