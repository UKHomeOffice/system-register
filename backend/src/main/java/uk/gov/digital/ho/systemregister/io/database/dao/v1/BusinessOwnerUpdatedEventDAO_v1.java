...
public class BusinessOwnerUpdatedEventDAO_v1 extends BaseDao {
    public final int id;
    ...
    public BusinessOwnerUpdatedEventDAO_v1(int id, Instant timestamp, Person author) {
        this(id, null, timestamp, author);
    }

    public BusinessOwnerUpdatedEventDAO_v1(int id, String businessOwner, Instant timestamp, Person author) {
        super(timestamp);
        this.id = id;
