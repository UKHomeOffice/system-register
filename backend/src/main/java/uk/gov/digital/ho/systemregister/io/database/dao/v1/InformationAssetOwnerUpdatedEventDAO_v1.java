...
public class InformationAssetOwnerUpdatedEventDAO_v1 extends BaseDao {
    public final int id;
    ...
    public InformationAssetOwnerUpdatedEventDAO_v1(int id, Instant timestamp, Person author) {
        this(id, null, timestamp, author);
    }

    public InformationAssetOwnerUpdatedEventDAO_v1(int id, String informationAssetOwner, Instant timestamp, Person author) {
        super(timestamp);
        this.id = id;
