...
import uk.gov.digital.ho.systemregister.application.messaging.commandhandlers.UpdateInformationAssetOwnerCommandHandler;
import uk.gov.digital.ho.systemregister.application.messaging.commands.UpdateInformationAssetOwnerCommand;
import uk.gov.digital.ho.systemregister.domain.SR_Person;
import uk.gov.digital.ho.systemregister.io.api.dto.UpdateInformationAssetOwnerCommandDTO;
...
@Path("/api/systems")
public class UpdateInformationAssetOwnerResource {
    private final UpdateInformationAssetOwnerCommandHandler handler;
    private final AuthorMapper authorMapper;

    public UpdateInformationAssetOwnerResource(UpdateInformationAssetOwnerCommandHandler handler, AuthorMapper authorMapper) {
    ...
    @Authenticated
    @Path("/{systemId}/update-information-asset-owner")
    public UpdatedSystemDTO updateInformationAssetOwner(UpdateInformationAssetOwnerCommandDTO dto,
        ...
        UpdateInformationAssetOwnerCommand command = dto.toCommand(id, author, Instant.now());
