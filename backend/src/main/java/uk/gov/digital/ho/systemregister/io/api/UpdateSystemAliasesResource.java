...
import uk.gov.digital.ho.systemregister.application.messaging.commandhandlers.UpdateSystemAliasesCommandHandler;
import uk.gov.digital.ho.systemregister.application.messaging.commands.UpdateSystemAliasesCommand;
import uk.gov.digital.ho.systemregister.domain.SR_Person;
import uk.gov.digital.ho.systemregister.io.api.dto.UpdateSystemAliasesCommandDTO;
...
@Path("/api/systems")
public class UpdateSystemAliasesResource {
    private final UpdateSystemAliasesCommandHandler handler;
    private final AuthorMapper authorMapper;

    public UpdateSystemAliasesResource(UpdateSystemAliasesCommandHandler handler, AuthorMapper authorMapper) {
    ...
    @Authenticated
    @Path("/{systemId}/update-system-aliases")
    public UpdatedSystemDTO updateSystemAliases(UpdateSystemAliasesCommandDTO dto,
        ...
        UpdateSystemAliasesCommand command = dto.toCommand(id, author, Instant.now());
