...
import uk.gov.digital.ho.systemregister.application.messaging.commandhandlers.UpdateDevelopedByCommandHandler;
import uk.gov.digital.ho.systemregister.application.messaging.commands.UpdateDevelopedByCommand;
import uk.gov.digital.ho.systemregister.domain.SR_Person;
import uk.gov.digital.ho.systemregister.io.api.dto.UpdateDevelopedByCommandDTO;
...
@Path("/api/systems")
public class UpdateDevelopedByResource {
    private final UpdateDevelopedByCommandHandler handler;
    private final AuthorMapper authorMapper;

    public UpdateDevelopedByResource(UpdateDevelopedByCommandHandler handler, AuthorMapper authorMapper) {
    ...
    @Authenticated
    @Path("/{systemId}/update-developed-by")
    public UpdatedSystemDTO updateDevelopedBy(UpdateDevelopedByCommandDTO dto,
        ...
        UpdateDevelopedByCommand command = dto.toCommand(id, author, Instant.now());
