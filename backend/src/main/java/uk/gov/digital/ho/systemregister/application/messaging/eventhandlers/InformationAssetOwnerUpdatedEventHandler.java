...
@ApplicationScoped
public class InformationAssetOwnerUpdatedEventHandler implements EventHandler {
    private final IEventStore eventStore;

    public InformationAssetOwnerUpdatedEventHandler(@Named("postgres") IEventStore eventStore) {
